...
public class ImageControllerTest {
  ...
  public void testControllerMethods() throws Exception {
    ...
    ImageView view = new ImageView(in, out);
    ImageController imageController = new ImageController(mockImageModel, view);
    ...
    assertEquals("Creating a red image with name landscape-jpg-red-component\n"
            ...
            + "Creating a value image with name landscape-jpg-value-component\n"
            + "Creating a luma image with name landscape-jpg-luma-component\n"
            + "Creating an intensity image with name landscape-jpg-intensity-component\n"
  ...
  public class MockImageModel extends ImageModel {
    ...
    public void valueImage(String name, String save, double p) {
      log.append("Creating a value image with name " + save + "\n");
    }

    @Override
    public void intensityImage(String name, String save, double p) {
      log.append("Creating an intensity image with name " + save + "\n");
    }

    @Override
    public void lumaImage(String name, String save, double p) {
      log.append("Creating a luma image with name " + save + "\n");
    }
    ...
    public void sepiaImage(String name, String save, double p) {
      log.append("Applying sepia filter to image with name "
              + name + " and saving as " + save + "\n");
    }

    @Override
    public void blurImage(String name, String save, double p) {
      log.append("Applying blur filter to image with name "
              + name + " and saving as " + save + "\n");
    }

    @Override
    public void sharpenImage(String name, String save, double p) {
      log.append("Applying sharpen filter to image with name "
              + name + " and saving as " + save + "\n");
    }
